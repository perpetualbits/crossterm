...
pub use text::{
    caret_from_visual_col, caret_visual_col, elide, render_line, render_wrapped, shape_digits,
    shape_line, visual_step, wrap, wrap_into_slots, BaseDirection, CursorMap, DigitShaping, TextCtx,
